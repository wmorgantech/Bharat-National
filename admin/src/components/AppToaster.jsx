...
/**
 * The single notification surface for the admin panel.
 *
 * Toastify is the only notification library in the project - modals are
 * reserved for confirmations and for data entry, never for reporting the
 * result of an action that already toasts.
 */
const ICONS = {
