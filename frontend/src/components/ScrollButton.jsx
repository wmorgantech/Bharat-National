...
export default function ScrollToTopButton() {
 ...
 bg-[var(--primary)] text-ink-900 shadow-lg
 ...
 <div
 className="
 hidden sm:block px-3 py-1 rounded-full bg-white text-[11px]
 font-medium text-ink-700 shadow-sm border border-ink-200
 ...
 className={`
 flex h-11 w-11 items-center justify-center rounded-full 
 bg-white shadow-lg border border-ink-200
