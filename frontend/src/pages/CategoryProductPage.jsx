...
import { PackageOpen, Search, X, SlidersHorizontal } from "lucide-react";
...
// Sorting runs over the list the API already returned - no extra requests.
const SORTS = [
  ...
  return (
    <div className="min-h-screen">
      ...
      <PageHeroBreadcrumb
        ...
        title={label}
        currentLabel={label}
        subtitle={`Everything we stock in ${label.toLowerCase()}.`}
      />
      ...
      <main className="relative section overflow-hidden">
        ...
        <div className="relative section-shell">
          ...
          {/* ---- Loading ---- */}
          {loading && (
            <div className="grid w-full grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 md:gap-5">
